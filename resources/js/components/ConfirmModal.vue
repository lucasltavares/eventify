      ...
      <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 transform transition-all">
          <div class="text-center">
            <div class="mx-auto w-16 h-16 rounded-full bg-error-50 flex items-center justify-center mb-4">
            ...
            <div class="flex gap-3">
              ...
              <button @click="$emit('confirm')" class="flex-1 bg-error-500 text-white px-4 py-2.5 rounded-xl font-medium hover:bg-error-600 transition-colors">
                {{ confirmText }}
              </button>
            </div>
          </div>
